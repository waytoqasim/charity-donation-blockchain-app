...
<footer class="w-full py-16 bg-gray-100">
    <div class="md:px-12 lg:px-28">
        <div class="container m-auto space-y-6 text-gray-600">
            <img src="https://www.palacehalf.com/wp-content/uploads/2019/01/Run-for-Charity-1.png" alt="logo tailus" class="w-40 m-auto" />
            <ul role="list" class="py-4 flex flex-col gap-4 items-center justify-center sm:flex-row sm:gap-8">
                ...
                <li role="listitem"><a href="/Donate" class="hover:text-cyan-500">Donate</a></li>
                <li role="listitem"><a href="/About" class="hover:text-cyan-500">About</a></li>
                <li role="listitem"><a href="Team" class="hover:text-cyan-500">Team</a></li>
            </ul>
